...
static inline bool
simd_available(int nInputPlanes, int nOutputPlanes)
{
    return ((nInputPlanes % (VEC_NELEM*4)) == 0 &&
            (nOutputPlanes % (VEC_NELEM*2)) == 0);
}

static void
apply_filter_line(unsigned long width,
